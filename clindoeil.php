...
<body>
            ...
            <div class="container"><a class="navbar-brand" href="index.php"><img src="logo.png" width="200px" height="100px"></a>
                ...
                <div class="collapse navbar-collapse"
                    ...
                    <ul class="nav navbar-nav ml-auto">
						...
						<li class="nav-item" role="presentation">
                        	<a class="nav-link active" href="clindoeil.php">Clin d'oeil</a>
                        </li>
	...
	<h1 class="text-center textevert">Clin d'oeil :</h1>
  ...
  <?php foreach($clindoeil as $clindoeil): ?>
    <div class="col-lg-4">
      <h5 class="text-center"><?= $clindoeil->LibTitrA ?></h5>
      <img src="<?= $clindoeil->UrlPhotA ?>" width ="350px" height="300px">
      <time><?= $clindoeil->DtCreA ?></time>
      <p><?= $clindoeil->LibChapoA ?></p>
      <center><a href="article.php?NumArt=<?= $clindoeil->NumArt ?>">Lire</a></center>
    </div>
    <?php endforeach; ?>
